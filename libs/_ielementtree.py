...
try:
    ...
    if VERSION >= (3, 3):
        ...
        if PLATFORM == 'darwin':
            from _macosx_universal_py26._ielementtree import *
            platform = "MacOS X Universal"
        elif PLATFORM.startswith('linux'):
            if ARCH == 'x64':
                from _linux_libcpp6_x86_64_py26._ielementtree import *
                platform = "Linux 64 bits"
            elif ARCH == 'x32':
                from _linux_libcpp6_x86_py26._ielementtree import *
                platform = "Linux 32 bits"
        elif PLATFORM.startswith('win'):
            if ARCH == 'x64':
                from _win64_py26._ielementtree import *
                platform = "Windows 64 bits"
            elif ARCH == 'x32':
                from _win32_py26._ielementtree import *
                platform = "Windows 32 bits"
